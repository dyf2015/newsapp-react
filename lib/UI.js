...
var UI = (function (_React$Component) {
  ...
  _createClass(UI, [{
    ...
    value: function componentDidMount() {
      ...
      _ntesPubsub2['default'].subscribe('newsapp:title', function (title) {
        _this.refs.title.src = 'docmode://modifytitle/' + encodeURIComponent(title);
      });
    }
  }, {
    key: 'componnetDidUpdate',
    value: function componnetDidUpdate() {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement('iframe', { ref: 'title', style: style });
    }
  }]);
